...
const Header = () => {
  ...
  const handelLogout = () => {
    logout()
      .then(() => {
        toast.warning("logout success fully see you next Time", {
          autoClose: 1000,
        });
      })
  ...
  return (
    <div className="sticky top-0 shadow-lg bg-base-100 ">
      <div className="navbar lg:container lg:mx-auto">
        <div className="flex-1 justify-between">
          <div className="flex items-center">
            ...
            <Link
              to="/"
              className="text-3xl lg:text-5xl font-bold text-blue-300"
            >
              Learn
              <span className="text-xl lg:text-3xl font-bold text-yellow-400">
                world
              </span>
            </Link>
          </div>
