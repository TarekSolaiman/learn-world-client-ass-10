      ...
      <div className="lg:flex md:flex justify-center items-center bg-blue-300">
        <div className="text-white md:w-2/5 lg:w-2/5">
          ...
          <p className="text-lg font-semibold pt-3">
            We have <span className="text-yellow-400">40k+</span> Online courses
            & <span className="text-yellow-400">500k+</span> Online registered
            student. Find your desired Courses from them.
          </p>

          <p className="text-lg font-semibold pt-3">
            <span className="text-yellow-400">500k+</span>People already trusted
            us.{" "}
